...
def main(args, i, save_path):
    ...
    print("Start training source_encoder and label_predictor.")
    ...
    print("Start training target_encoder and discriminator.")
    ...
    for epoch in range(args.epochs):
        ...
        print(f"Epoch {epoch}, train loss: {loss_all:.4f}")
...
if __name__ == "__main__":
    ...
    os.makedirs("../ckpts/adda/1", exist_ok=True)
    main(args, 1, save_path="../ckpts/adda/1/")